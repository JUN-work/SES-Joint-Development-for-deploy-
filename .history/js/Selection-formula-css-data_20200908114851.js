const SF_css_data = [
    ...
    },
    {
        ...
        'answer':'flex-wrap', // 解答
        'explanation': 'flexbox（flexコンテナ内のflexアイテム）の横または縦の折り返し方法を指定することができる。', // 解説
        'url':'https://web-designer.cman.jp/css_ref/abc_list/order/', //詳細リンク
    },
    {
        'id': 76,
        ...
        'explanation': 'flexbox（flexコンテナ内のflexアイテム）の自動幅調整（縮む）を指定することができる。', // 解説
    ...
    },
    {
        ...
        'answer':'flex-grow', // 解答
        'explanation': 'flexbox（flexコンテナ内のflexアイテム）の自動幅調整（伸ばす）を指定することができる。', // 解説
    ...
    },
    {
        ...
        'answer':'flex-flow', // 解答
        'explanation': 'flexbox（flexコンテナ内のflexアイテム）の並びと折り返しをまとめて指定することができる。', // 解説
    ...
    },
    {
        ...
        'explanation': 'flexbox（flexコンテナ内のflexアイテム）の横または縦の並び方向を指定することができる。', // 解説
    ...
    },
    {
        ...
        'explanation': 'flexbox（flexコンテナ内のflexアイテム）の幅を調整を指定することができる。', // 解説
